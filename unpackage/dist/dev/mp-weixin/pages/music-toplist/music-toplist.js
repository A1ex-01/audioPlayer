...
/* harmony import */ var _music_toplist_vue_vue_type_style_index_0_id_44b2c31e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./music-toplist.vue?vue&type=style&index=0&id=44b2c31e&lang=scss&scoped=true& */ 174);
...
var _index = _interopRequireDefault(__webpack_require__(/*! ../../store/index */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _default =
{
  ...
  onLoad: function onLoad(options) {var _this = this;
    ...
    setTimeout(function () {
      console.log("playlist", _this.playList.tracks);
    }, 1000);
  },
  methods: {
    getPageList: function getPageList() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _yield$getrecommend, playlist;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  (0, _api.getrecommend)(_this2.idx));case 2:_yield$getrecommend = _context.sent;playlist = _yield$getrecommend.playlist;
                _this2.playList = playlist;case 5:case "end":return _context.stop();}}}, _callee);}))();
    },
    getSongMeauList: function getSongMeauList() {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var _yield$getSongMeauDet, playlist;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                  (0, _api.getSongMeauDetailById)(_this3.meauId));case 2:_yield$getSongMeauDet = _context2.sent;playlist = _yield$getSongMeauDet.playlist;
                _this3.playList = playlist;case 5:case "end":return _context2.stop();}}}, _callee2);}))();
    },
