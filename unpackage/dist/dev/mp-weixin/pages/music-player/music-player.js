...
var _musicPlayer = _interopRequireDefault(__webpack_require__(/*! ./pages/music-player/music-player.vue */ 187));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _music_player_vue_vue_type_template_id_d71fa2b4_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./music-player.vue?vue&type=template&id=d71fa2b4&scoped=true& */ 188);
/* harmony import */ var _music_player_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./music-player.vue?vue&type=script&lang=js& */ 190);
...
/* harmony import */ var _music_player_vue_vue_type_style_index_0_id_d71fa2b4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./music-player.vue?vue&type=style&index=0&id=d71fa2b4&lang=scss&scoped=true& */ 192);
...
try {
  components = {
    TitleBar: function() {
      return __webpack_require__.e(/*! import() | components/TitleBar/TitleBar */ "components/TitleBar/TitleBar").then(__webpack_require__.bind(null, /*! @/components/TitleBar/TitleBar.vue */ 251))
    },
    musicUi: function() {
      return __webpack_require__.e(/*! import() | components/music-ui/music-ui */ "components/music-ui/music-ui").then(__webpack_require__.bind(null, /*! @/components/music-ui/music-ui.vue */ 258))
    },
    MusicChapter: function() {
      return __webpack_require__.e(/*! import() | components/MusicChapter/MusicChapter */ "components/MusicChapter/MusicChapter").then(__webpack_require__.bind(null, /*! @/components/MusicChapter/MusicChapter.vue */ 265))
    }
  }
} catch (e) {
  if (
...
var _parseLyric = _interopRequireDefault(__webpack_require__(/*! ../../utils/parse-lyric */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var musicUi = function musicUi() {__webpack_require__.e(/*! require.ensure | components/music-ui/music-ui */ "components/music-ui/music-ui").then((function () {return resolve(__webpack_require__(/*! ../../components/music-ui/music-ui.vue */ 258));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
{
  ...
  methods: {
    getPageInfo: function getPageInfo() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                // const { songs } = await getSongDetailInfo(this.ids);
                // console.log("base",songs);
                uni.request({
                  url: 'https://axplayer-node.vercel.app/song/detail?ids=' + _this.ids,
                  success: function success(res) {var
                    songs = res.data.songs;
                    _index.default.commit("getSongInfo", songs[0]);
    ...
    getLyric: function getLyric() {
      ...
      uni.request({
        ...
        success: function success(res) {
          ...
          _index.default.commit("getSongLyric", (0, _parseLyric.default)(res.data.lrc.lyric));
        } });
