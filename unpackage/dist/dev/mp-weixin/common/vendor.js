...
var store = new _vuex.default.Store({
  ...
  mutations: {
    getIds: function getIds(state, payload) {var _this = this;
      ...
      // setTimeout(() => {
      _store.default.title = payload.ids;
      // }, 500);
      // audio.autoplay = true;
      _store.default.play();
      // audio.onCanplay(() => {
  ...
  actions: {
    updateAllInfo: function updateAllInfo(_ref, payload) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var commit;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:commit = _ref.commit;
                ...
                uni.request({
                  ...
                  success: function success(res) {
                    ...
                    commit("getSongLyric", (0, _parseLyric.default)(res.data.lrc.lyric));
                  } });

                // commit("getSongLyric", parseLyric(lrc.lyric));
              case 3:case "end":return _context.stop();}}}, _callee);}))();} } });var _default =
...
/* 149 */
/*!***********************************************************!*\
  !*** D:/前端开发/uni_app/AXplayer/pages.json?{"type":"stat"} ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__0C90AAA" };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _request2 = __webpack_require__(/*! ./request.js */ 175);
